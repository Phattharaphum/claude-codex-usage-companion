...
EXTENSION_ID="claude-codex-usage-companion-fork-v2@gamephat.local"
STALE_FORK_EXTENSION_ID="claude-codex-usage-companion-fork@gamephat.local"
...
gnome-extensions disable "$STALE_FORK_EXTENSION_ID" 2>/dev/null || true
